...
window.I18n = (() => {
  ...
  const en = {
    ...
    'erros/h': 'errors/h', 'execuções/h': 'executions/h', 'rodando': 'running', 'travadas': 'stuck',
    ...
    'Alertar execução em andamento acima de (minutos)': 'Alert running executions above (minutes)',
    'Vale para todo fluxo que não tiver exceção abaixo.': 'Applies to every workflow without an exception below.',
    'Exceções por fluxo': 'Per-workflow exceptions',
    'Para fluxos que são lentos por natureza. Sem exceção eles alertam em toda execução, e um alerta que sempre aparece sem nada de errado ensina a ignorar o painel.': 'For workflows that are slow by nature. Without an exception they alert on every run, and an alert that always fires with nothing wrong teaches people to ignore the panel.',
    'Adicionar exceção': 'Add exception',
    'Selecione o fluxo…': 'Select the workflow…',
    ...
    'https://exemplo.com/webhook': 'https://example.com/webhook', 'https://evolution.exemplo.com': 'https://evolution.example.com',
    'minha-instancia': 'my-instance',
    ...
    'Entrar': 'Sign in', 'Sair': 'Sign out', 'Workspace': 'Workspace', 'Workspaces': 'Workspaces',
    'Primeiro acesso': 'First-time setup', 'Criar e entrar': 'Create and sign in',
    'Entre com e-mail e senha.': 'Sign in with email and password.',
    'Crie o usuário administrador e o primeiro workspace. O cadastro público fica desligado depois disso.': 'Create the administrator and the first workspace. Public signup stays disabled afterwards.',
    'Novo workspace': 'New workspace', 'Nome do workspace': 'Workspace name', 'Criar workspace': 'Create workspace',
    'Workspace atual': 'Current workspace', 'Seus workspaces': 'Your workspaces', 'Salvar nome': 'Save name',
    'Nome salvo.': 'Name saved.', 'Não foi possível salvar o nome.': 'Could not save the name.',
    'Nenhum workspace.': 'No workspaces.',
    'Instâncias, tarefas e alertas deste workspace ficam isolados dos outros. Troque pelo seletor no topo.': 'Instances, tasks and alerts in this workspace stay isolated from the others. Switch it from the top selector.',
    'Gera um link copiável. Não envia e-mail.': 'Creates a copyable link. It does not send email.',
    'Usuários deste workspace': 'Users in this workspace', 'Cadastrar usuário': 'Create user',
    'Trocar senha no primeiro login': 'Change password on first login', 'Convidar': 'Invite',
    'Gerar convite': 'Create invite', 'Papel': 'Role', 'Membro': 'Member', 'Admin': 'Admin',
    'Aceitar convite': 'Accept invite', 'Entrar no workspace': 'Join workspace',
    'Trocar senha': 'Change password', 'Senha atual': 'Current password', 'Nova senha': 'New password',
    'Salvar senha': 'Save password', 'É necessário definir uma senha nova no primeiro acesso.': 'A new password is required on first sign-in.',
    'Cada workspace tem instâncias, tarefas e alertas isolados. Troque pelo seletor no topo.': 'Each workspace has isolated instances, tasks and alerts. Switch it from the top selector.',
    'atual': 'current', 'trocar senha': 'change password', 'Usuário cadastrado.': 'User created.',
    'Workspace criado. Recarregando…': 'Workspace created. Reloading…',
    'Nenhum usuário listado.': 'No users listed.',
    'E-mail': 'Email', 'Senha': 'Password', 'Monitor n8n': 'n8n Monitor',
    'Entrar — Monitor n8n': 'Sign in — n8n Monitor',
    'Configuração inicial — Monitor n8n': 'Initial setup — n8n Monitor',
    'Convite — Monitor n8n': 'Invite — n8n Monitor',
    'Trocar senha — Monitor n8n': 'Change password — n8n Monitor',
    'Não foi possível entrar.': 'Could not sign in.',
    'Não foi possível concluir o setup.': 'Could not complete setup.',
    'Não foi possível trocar a senha.': 'Could not change the password.',
    'Não foi possível aceitar.': 'Could not accept the invite.',
    'Não foi possível carregar o convite.': 'Could not load the invite.',
    'Carregando convite…': 'Loading invite…',
    'Convite inválido.': 'Invalid invite.',
    'Você foi convidado para {workspace} como {role}.': 'You were invited to {workspace} as {role}.',
    'criando…': 'creating…', 'salvando…': 'saving…', 'falhou': 'failed',
    '(copiado)': '(copied)', '{link} (copiado)': '{link} (copied)',
    'owner': 'Owner', 'admin': 'Admin', 'member': 'Member',
    'English': 'English', 'N8N': 'N8N', 'status': 'status', 'p95': 'p95',
    'buscar por nome do fluxo ou número da execução…': 'search by workflow name or execution number…',
  }
  ...
  const padroes = [
    ...
    [/^(.*) \(copiado\)$/, '$1 (copied)'],
    [/^Você foi convidado para (.*) como (.*)\.$/, 'You were invited to $1 as $2.'],
  ]
